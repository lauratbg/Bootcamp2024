...
import { Categoria, CategoriasDAOService, CategoriasViewModelService } from './servicios.service';
...
describe('Modulo Categorias', () => {
  ...
  describe('DAOService', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [CategoriasDAOService, HttpClient],
      });
    });
  ...
  describe('ViewModelService', () => {
    ...
    describe('mode', () => {
      ...
      it('add', () => {
        service.add()
        expect(service.Elemento).withContext('Verify Elemento').toEqual(new Categoria())
    ...
    describe('send', () => {
      describe('add', () => {
        it('OK', fakeAsync(() => {
          ...
          const ele = new Categoria() as any;
